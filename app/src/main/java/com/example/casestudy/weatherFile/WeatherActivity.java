package com.example.casestudy.weatherFile;
...
import com.example.casestudy.Common;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    protected void getWeatherData() {
        ...
        Call<WeatherPojo> call = api.getData(this.getIntent().getStringExtra("object"), key, WeatherApi.Temp_Unit);
